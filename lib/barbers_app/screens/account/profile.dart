...
//                                                                        TextAlign
//                                                                            .start,
//                                                                        text:checkDirection("قص الشعر", "King Salon ")
//
//                                                                    )),
//                                                              ],
//                                                            ),)
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(width: width*.4,
                                                                            child: customDescriptionTextText(
                                                                                ...
                                                                                TextAlign
                                                                                    .start,
                                                                                text:checkDirection("على عمرو", "Ali Amr")
                                                                      ...
                                                                      children: [
                                                                        Container(width: width*.6,
                                                                            child: customDescriptionTextText(
                                                                                ...
                                                                                TextAlign
                                                                                    .start,
                                                                                text:checkDirection("هو حلاق متميز ومتقن في عمله ... شكرا لك ", "He is a good barber , thanks ")
...
//                  showCustomAlertDialog(alertSubtitle: checkDirection("تم إرسال الحجز بنجاح ", "appointment has been sent successfully ! "
//                  ),context: context  , alertTitle: checkDirection("تم", "Done !") , onTapOk:
