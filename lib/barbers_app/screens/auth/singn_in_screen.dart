import 'package:almezynbarber/barbers_app/screens/app_tab/appForBarber.dart';
import 'package:almezynbarber/custom_widgets/custom_build_body.dart';
import 'package:almezynbarber/custom_widgets/custom_button.dart';
import 'package:almezynbarber/custom_widgets/custom_description_text.dart';
import 'package:almezynbarber/custom_widgets/custom_push_named_navigation.dart';
import 'package:almezynbarber/custom_widgets/entry_field.dart';
import 'package:almezynbarber/custom_widgets/responsive_sized_box.dart';
...
import 'package:almezynbarber/utils/colors.dart';
import 'package:almezynbarber/utils/constants.dart';
import 'package:almezynbarber/utils/icons.dart';
import 'package:almezynbarber/utils/responsive.dart';
...
import 'package:almezynbarber/barbers_app/screens/auth/Login/cubit/state_login.dart';
...
//                  .then((value) {
              customPushNamedNavigation(context, AppTabForBarber());
//              }
//            );
            }
          }
                            ...
                            children: [
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.center,
                                ...
                                customDescriptionTextText(context: context ,textColor: blueColor  ,
                                    text: "Register" , fontWeight: FontWeight.bold , percentageOfHeight: .033)
                              ],),
                              responsiveSizedBox(context: context , percentageOfHeight: .02),
                              EntryField(
                                controller: _name,
                              ...
                              is! MezaynLoginLoadingState) ...[
                                Container(
                                    ...
                                    child:CustomButton(text:translator.translate("Register"), onTapButton:()
                                    {
                                      print(
                                          "add address tapped ");
                                    ...
                                    if(value.statusCode == 200 && value.data["validation_error"] != null ){
                                      ...
                                      CacheHelper.putStringData(key: "token", value: value.data["access_token"]["token"]);
                                      ...
                                      CacheHelper.putStringData(key: "user_id", value: value.data["user"]["phone"] ,);
                                      CacheHelper.putStringData(key: "user_type", value: value.data["user"]["type"] ,);
                                      CacheHelper.putStringData(key: "user_image", value: value.data["user"]["image"] ,);
