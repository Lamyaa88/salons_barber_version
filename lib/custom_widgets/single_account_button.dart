           ...
           child: Center(
             ...
             child: Column(mainAxisSize: MainAxisSize.min,
               children: [
                 ...
                 Row(children: [
               customDescriptionTextText(context: context , text:  title,textAlign: TextAlign.start,
               ...
               children: [
                 customDescriptionTextText(context: context , text:  subtitle  , percentageOfHeight: .013),
